                ...
                <div class="col-lg-12 col-md-12">
					...
					<div class="our-Project-nav wow fadeInUp">
						<ul>
							...
							<li><a href="#" data-filter=".brand">Brand strategy</a></li>
							<li><a href="#" data-filter=".content">Content creation</a></li>
							<li><a href="#" data-filter=".uiux">UI/UX design</a></li>
							<li><a href="#" data-filter=".social">Social media</a></li>
						</ul>
					</div>

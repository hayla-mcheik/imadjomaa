      ...
      <div class="section-title">
        ...
        <div class="lg:col-span-4 relative hidden lg:block">
          <div class="hero-image-container relative">
            <div class="absolute inset-0 rounded-full bg-gradient-to-r from-black to-red-600 blur-2xl opacity-30 animate-pulse"></div>
            <img src="/assets/images/main-image.png" class="relative z-10 w-full max-w-md mx-auto animate-float" alt="Creative Agency">
          </div>
        </div>
